...
For example, code smells are an example of technical debt items that may increase future
...
activities and if there is an associated business value.  A key concern, therefore, is the ability to measure and make rationale cost-benefit analyses of the impact of technical debt on productivity within a project, capturing both the principal debt incurred and consequent interest, as poor code quality accumulates.

The primary research objective is to identifying the extra work incurred due to
