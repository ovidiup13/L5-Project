...
The initial technical debt average is shown in table \ref{tab-technical-debt-total}.
...
\begin{figure*}[htp]
	...
	\begin{subfigure}{.45\textwidth}
		...
		\label{fig:spring-td-timeline}
	\end{subfigure}
	\caption{Technical Debt and Work Effort by Commit (Checkstyle)}
	\label{fig:td-timeline}
\end{figure*}
...
\begin{figure*}[htp]
	...
	\begin{subfigure}{.45\textwidth}
		...
		\label{fig:spring-td-timeline}
	\end{subfigure}
	\caption{Technical Debt and Work Effort by Ticket (Checkstyle)}
	\label{fig:td-timeline}
\end{figure*}
