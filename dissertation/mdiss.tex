...
implementation costs. In this paper, we described our proposed approach to
measuring the cost of implementation of a work item within five project
histories and measuring the impact of technical debt on implementation cost. It
is hoped that this study is the first step in a series to empirically identify technical debt rovision of a decision-support method to enable software project teams to
