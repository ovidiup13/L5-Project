...
development. Interest probability was calculated by counting the frequency of a
code smell and relating it with the change proneness of the module where it
resides. The smells studied were Long Method, Conditional Complexity, and Duplicated Code.
