...
Possible approach: 
\begin{enumerate}
	\item Identify appropriate data candidates for this study. These are a
mixture of open source and enterprise software.
	\item Identify and retrieve suitable work items from project planning software.
	\item Identify checkpoints in project codebase which are appropriate to the
selected work items.
